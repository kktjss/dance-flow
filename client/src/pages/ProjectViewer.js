                    ...
                    <Paper sx={{ p: 4, minHeight: '500px' }}>
                        {loading ? (
                            ...
                            <Box>
                                ...
                                {/* Здесь будет компонент для просмотра проекта */}
                                <Box sx={{ mt: 4 }}>
                                    ...
                                    {project.elements && project.elements.length > 0 ? (
                                        <Box>
                                            {/* Здесь будет отображение элементов проекта */}
                                            <Typography>
                                                Количество элементов: {project.elements.length}
                                            </Typography>
                                        </Box>
                                    ) : (
                                        <Typography color="text.secondary">
                                            В проекте пока нет элементов
                                        </Typography>
                                    )}
                                </Box>
                            </Box>
