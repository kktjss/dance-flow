...
const StyledButton = styled(Button)(({ theme }) => ({
    ...
    '&:hover': {
        boxShadow: `0 10px 25px rgba(${parseInt(COLORS.secondary.slice(1, 3), 16)}, ${parseInt(COLORS.secondary.slice(3, 5), 16)}, ${parseInt(COLORS.secondary.slice(5, 7), 16)}, 0.6)`,
...
const StyledTextField = styled(TextField)(({ theme }) => ({
    ...
    '& .MuiOutlinedInput-root': {
        ...
        '&.Mui-focused fieldset': {
            ...
            boxShadow: `0 0 10px rgba(${parseInt(COLORS.secondary.slice(1, 3), 16)}, ${parseInt(COLORS.secondary.slice(3, 5), 16)}, ${parseInt(COLORS.secondary.slice(5, 7), 16)}, 0.3)`,
        },
    },
    '& .MuiInputLabel-root': {
...
const DecorativeCircle = styled(Box)(({ size = 120, top, left, color = COLORS.secondary, delay = 0 }) => ({
    position: 'absolute',
    width: `${size}px`,
    height: `${size}px`,
    borderRadius: '50%',
    ...
    return (
        <Box sx={{
            ...
            <Container component="main" maxWidth="sm" sx={{ flex: 1, display: 'flex', alignItems: 'center' }}>
                ...
                >
                    {/* Декоративные элементы */}
                    <DecorativeCircle top="-50px" left="-80px" size={200} color={COLORS.secondary} delay={0.2} />
                    <DecorativeCircle top="30%" left="90%" size={150} color={COLORS.tertiary} delay={0.4} />
                    <DecorativeCircle top="80%" left="5%" size={100} color={COLORS.primary} delay={0.6} />
